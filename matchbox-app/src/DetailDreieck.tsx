    ...
    const hotspots = [
        {
            ...
            position: "0.02 0.37 0.00",
            content: (
                <p>
                    <strong>Öffnung</strong> (für Sand)<br />
                    Durch die flache und breite Öffnung kann die Feuerwehr Sand kontrolliert verteilen<br />
                </p>
            )
        },
        {
            ...
            position: "0.10 0.19 0.00",
            content: (
                <div className="space-y-2">
                    <p><strong>Einfaches Tragen:</strong><br />
                        Da Sand schwer ist, brauchte man eine Möglichkeit diesen speziellen Sandfeuerlöscher zu halten. Dafür sind zwei halterungen angebracht worden, eine unten und eine oben. </p>
                </div>
            )
        }
    ];
  ...
  return (
      <div className="fixed inset-0 bg-blue-500 flex flex-col overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-[56px] bg-blue-500 z-50 flex items-center px-4 shadow-[0_4px_10px_-2px_rgba(0,0,0,0.25)]">
          ...
          <Link to="/ARDreieck" className="hover:opacity-80 transition-opacity">

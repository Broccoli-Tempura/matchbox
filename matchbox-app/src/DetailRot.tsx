...
export function DetailRot() {
 ...
 // Hier speichern wir die Daten für alle Info-Fenster
    const hotspots = [
        {
            id: 1,
            // Deine perfekten Koordinaten für Punkt 1:
            position: "0.08 0.37 -0.04",
            content: (
                <p>
                    <strong>Brevo Schaumlöscher</strong><br />
                    Hergestellt 1920 in Horgen<br />
        ...
        {
            id: 2,
            // Deine perfekten Koordinaten für Punkt 2:
            position: "0.08 0.46 0.07",
            content: (
                <div className="space-y-2">
                    <p><strong>Sprühkopf</strong><br />
                        Hier kommt der Schaum raus. Im gegensatz zu modernen Modellen hatte man damals keinen Schlauch dran. Zum Gebrauch hielt man den Feuerlöscher kopfüber, so, dass dieser Sprühkopf unten war.</p>
                </div>
            )
        }
    ];
  ...
  return (
      <div className="fixed inset-0 bg-blue-500 flex flex-col overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-[56px] bg-blue-500 z-50 flex items-center px-4 shadow-[0_4px_10px_-2px_rgba(0,0,0,0.25)]">
          ...
          <Link to="/ARRot" className="hover:opacity-80 transition-opacity">
        ...
        >
          <ModelViewer
              src={`${import.meta.env.BASE_URL}models/rot.glb`}
